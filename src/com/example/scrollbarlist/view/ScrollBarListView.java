...
public class ScrollBarListView extends LinearLayout implements OnTouchListener {
	...
	private void init(Context context) {
		...
		ViewGroup main = (ViewGroup) inflater.inflate(R.layout.scroll_bar_list_view, null);
